...
/// Query type alias for physics movement system
#[allow(clippy::type_complexity)]
type PhysicsMovementQuery<'a> = Query<
    'a,
    'a,
    (
        &'a mut Transform,
...
pub fn physics_movement_system(time: Res<Time>, mut query: PhysicsMovementQuery) {
